...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-indigo-500 text-start text-base font-medium text-indigo-400 bg-gray-800 focus:outline-none focus:text-indigo-300 focus:bg-gray-800 focus:border-indigo-600 transition duration-150 ease-in-out'
